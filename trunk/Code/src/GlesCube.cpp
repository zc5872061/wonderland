...
void GlesCube::OnTouchPressed(const Osp::Ui::Control &source, const Osp::Graphics::Point &currentPosition, const Osp::Ui::TouchEventInfo &touchInfo)
{
	Game::getInstance().touchPressed(currentPosition.x,SCREEN_HEIGHT - currentPosition.y);
}

void GlesCube::OnTouchReleased(const Osp::Ui::Control &source, const Osp::Graphics::Point &currentPosition, const Osp::Ui::TouchEventInfo &touchInfo)
{
